...
./FastTextBin/fasttext supervised -input labeled_sents_preprocessed.txt -output labeled_sents_preprocessed -epoch 37 -minCount 1 -neg 5 -wordNgrams 2 -bucket 4110692 -dim 169 -ws 5 -thread 8 -loss softmax -minn 0 -maxn 0 -lrUpdateRate 100 -t 0.0001
